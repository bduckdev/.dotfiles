...
awful.screen.connect_for_each_screen(function(s)
    ...
    if s == screen.primary then
        ...
        local names = { "secondary", "other" }
        local l = awful.layout.suit
        local layouts = { l.tile, l.tile }
        awful.tag(names, s, layouts)
    ...
    s.mywibox:setup({
        ...
        { -- Right widgets
            ...
            spotify_widget({
                ...
                sp_bin = "/home/bduck/.dotfiles/scripts/.local/scripts/sp",
                pause_icon = "/home/bduck/.local/share/icons/WhiteSur-dark/actions/32/media-playback-start.svg",
                play_icon = "/home/bduck/.local/share/icons/WhiteSur-dark/actions/32/media-playback-pause.svg",
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86MonBrightnessUp", function()
        awful.spawn("brightnessctl -c backlight set +5%")
    end),
    ...
    awful.key({ modkey }, "r", function()
        ...
        --menubar.show()
    end, { description = "run run", group = "launcher" }),
...
awful.rules.rules = {
    ...
    { rule = { class = "Spotify" },                 properties = { screen = 1, tag = tag2 } },
    { rule = { class = "deez-nuts" },               properties = { screen = 1, tag = tag3, switchtotag = false } },
    {
        rule = { class = "steam_app_2113850" },
        properties = { screen = 1, tag = tag3, switchtotag = false },
    },
    { rule = { class = "dev.zed.Zed" },   properties = { screen = 1, tag = tag4, switchtotag = false } },
    { rule = { class = "Brave-browser" }, properties = { screen = 1, tag = tag4, switchtotag = false } },
    { rule = { class = "obsidian" },      properties = { screen = 1, tag = tag5, switchtotag = false } },
    {
...
--awful.spawn.once("wezterm start --class foo", { floating = false, screen = 1, tag = tag1 }) awful.spawn.single_instance("spotify")
...
--awful.spawn.with_shell("~/.dotfiles/scripts/bin/.local/scripts/startup")
