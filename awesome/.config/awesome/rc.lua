...
awful.screen.connect_for_each_screen(function(s)
    ...
    if s == screen.primary then
        local names = { "Terminal", "Browser", "Spotify", "Telegram", "Discord" }
...
awful.rules.rules = {
    ...
    --{ rule = { class = "Brave-browser" }, properties = { screen = 1, tag = "Browser", switchtotag = true } },
    { rule = { class = "Spotify" },                 properties = { screen = 1, tag = "Spotify" } },
    {
        rule = { class = "TelegramDesktop" },
        properties = { screen = 1, tag = "Telegram" },
    },
    { rule = { class = "foo" }, properties = { screen = 1, tag = "Terminal", switchtotag = true } },
}
-- }}}
...
awful.spawn.once("brave-browser", { floating = false, screen = 1, tag = "Browser" })
--awful.spawn.once("brave-browser", { floating = false, screen = 2 })
--awful.spawn.once("wezterm", { floating = false, screen = 2 })
awful.spawn.once("wezterm start --class foo", { floating = false, screen = 1, tag = "Terminal" })
